...
class RecipeForm(forms.Form):
    ...
    config_json = forms.CharField(label="Configuration", required= False, widget=JsonPairInputs(val_attrs={'size':35}, key_attrs={'class':'large'}), initial='{"hostname":"","admin_username":"","admin_password":""}')
